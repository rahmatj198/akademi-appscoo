...
function stm_lms_enqueue_ss() {
	...
	wp_register_script( 'masterstudy-become-instructor-trigger', STM_LMS_URL . '/assets/js/components/modals/become-instructor-trigger.js', array( 'jquery' ), MS_LMS_VERSION, true );
	wp_register_script( 'masterstudy-become-instructor-request', STM_LMS_URL . '/assets/js/components/modals/become-instructor-request.js', array( 'jquery' ), MS_LMS_VERSION, true );
	wp_register_script( 'masterstudy-group-fields', STM_LMS_URL . '/assets/js/components/group-fields.js', array( 'jquery' ), MS_LMS_VERSION, true );
	wp_register_script( 'masterstudy-enterprise-trigger', STM_LMS_URL . '/assets/js/components/modals/enterprise-trigger.js', array( 'jquery' ), MS_LMS_VERSION, true );
	wp_register_script( 'masterstudy-enterprise-request', STM_LMS_URL . '/assets/js/components/modals/enterprise-request.js', array( 'jquery' ), MS_LMS_VERSION, true );
	...
	wp_register_style( 'masterstudy-group-fields', STM_LMS_URL . '/assets/css/components/group-fields.css', null, MS_LMS_VERSION );
	wp_register_style( 'masterstudy-become-instructor-modal', STM_LMS_URL . '/assets/css/components/become-instructor.css', null, MS_LMS_VERSION );
	wp_register_style( 'masterstudy-enterprise-modal', STM_LMS_URL . '/assets/css/components/modal-enterprise.css', null, MS_LMS_VERSION );
