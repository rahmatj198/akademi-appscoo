			...
			if ( empty( $data[ $field_key ] ) ) {
				...
				if ( empty( $data[ $field_key ] ) ) {
					$response['errors'][] = array(
						'id'    => 'valid',
						'field' => $field_key,
						'text'  => 'register_user_email' === $field_key ? esc_html__( 'Please enter a valid email', 'masterstudy-lms-learning-management-system' ) : esc_html__( 'Please enter valid field', 'masterstudy-lms-learning-management-system' ),
					);
				}
			}
		}
