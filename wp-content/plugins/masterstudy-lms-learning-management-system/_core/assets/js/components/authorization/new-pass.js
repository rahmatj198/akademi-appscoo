...
(function ($) {
  $(document).ready(function () {
    ...
    $('[data-id="masterstudy-authorization-new-pass-button"]').click(function (e) {
      e.preventDefault();
      if (new_pass_data.token.length > 0) {
        ...
        $('[data-id="masterstudy-authorization-new-pass-button"]').addClass('masterstudy-button_loading');
        fetch(url, {
          method: 'POST',
          headers: {
          ...
          $('[data-id="masterstudy-authorization-new-pass-button"]').removeClass('masterstudy-button_loading');
