...
(function ($) {
  $(document).ready(function () {
    $('.masterstudy-become-instructor-modal__header-title-close, .masterstudy-become-instructor-modal__close').on('click', function () {
    ...
    $('[data-masterstudy-modal]').on('click', function (e) {
      ...
      var commonParentModal = $(this).parents('.masterstudy-become-instructor-modal-parent');
      commonParentModal.find(".".concat(modalName)).addClass('active');
      setTimeout(function () {
        commonParentModal.find(".".concat(modalName, " .masterstudy-become-instructor-modal__wrapper")).addClass('active');
      }, 30);
    });
  });
})(jQuery);